# menu.py
import pygame
import maps  # This module should define level_one_test(), level_two(), etc.
...
class Level(pygame.sprite.Sprite):
    ...
    def draw(self, surface):
        ...
        level_text = self.font_1.render(f'Level {self.number}', True, WHITE)
        level_text_Rect = level_text.get_rect(center=(self.rect.x + 50, self.rect.y + 120))
        surface.blit(level_text, level_text_Rect)
        if self.condition == "unlocked":
            level_text_2 = self.font_2.render(f'1', True, WHITE)
            level_text_2_Rect = level_text_2.get_rect(center=(self.rect.x + 50, self.rect.y + 50))
